...
for x in ['礦井外湖泊','MinesDistances.png','矿井钓点','铁路',"18%",'SecretWoods','sdv-world-region-header-v78','sdv-world-custom-v78']:
...
if not re.search(r'\./world-route-fixes-v79\.js\?v=\d+',idx): fail('route-fix script missing')
for x in ['./world-extra-v79.js?v=79','deploy-v79']:
