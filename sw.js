const CACHE='stardew-tracker-v44';
const CORE=['./index.html','./app.js','./cloud.js','./wardrobe-data-v34.js','./farmer-preview-v33.js','./animal-preview-v33.js','./item-prices-v44.js','./manifest.webmanifest','./icon.svg'];
