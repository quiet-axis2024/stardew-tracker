...
function StardewTracker() {
  ...
  const handleProfileUpload = async (file) => {
    ...
    try {
      ...
      // v59: only auto-apply fields that are safe to verify from the fixed Switch UI.
