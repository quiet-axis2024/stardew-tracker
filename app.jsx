    ...
    <div style={{background:C.darkBrown,color:"white",padding:"calc(8px + env(safe-area-inset-top)) 12px 8px",position:"sticky",top:0,zIndex:30,boxShadow:"0 2px 8px rgba(0,0,0,.25)"}}>
      <div style={{display:"flex",alignItems:"center",gap:8}}>
        ...
        <div style={{textAlign:"right",minWidth:0}}>
          <div style={{fontWeight:950,fontSize:12.5,lineHeight:1.15,display:"flex",alignItems:"center",gap:4,justifyContent:"flex-end"}}><GameIcon file={SEASON_FILE_V97[data.base.season]} size={13}/> 第 {data.base.year} 年 {data.base.season} {data.base.day} 日</div>
