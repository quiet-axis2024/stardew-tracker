...
function StardewTracker() {
  ...
  const renderFarm = () => {
    ...
    const machineMetaV51=window.SDVMachineV51?.byName||{};
    const machineDefs={
      artisan:[
