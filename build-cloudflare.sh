...
python3 scripts/audit-world-v82.py
...
node --check world-nav-v82.js
node --check sw-v82.js
...
cp world-nav-data-v81.js world-nav-island-v81.js world-nav-v82.js sw-v82.js dist/
cp -R assets dist/
