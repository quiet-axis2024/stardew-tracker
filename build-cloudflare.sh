...
node --check world-lifecycle-v85.js
...
cp world-nav-data-v81.js world-nav-island-v81.js world-fish-data-v83.js world-nav-v83.js world-lifecycle-v85.js sw-v85.js dist/
cp -R assets dist/