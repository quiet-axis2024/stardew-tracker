...
python3 scripts/audit-world-v86.py
...
node --check world-lifecycle-v86.js
node --check sw-v86.js
...
cp world-nav-data-v81.js world-nav-island-v81.js world-fish-data-v83.js world-nav-v83.js world-lifecycle-v86.js sw-v86.js dist/
cp -R assets dist/