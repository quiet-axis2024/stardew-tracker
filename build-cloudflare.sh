...
python3 scripts/audit-world-v81.py
...
node --check world-nav-v81.js
node --check sw-v81.js
...
cp world-nav-data-v81.js world-nav-island-v81.js world-nav-v81.js sw-v81.js dist/
cp -R assets dist/
