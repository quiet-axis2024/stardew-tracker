...
window.SDVWorldV70={
  ...
  places:[
    ...
    {id:"bus_stop",regionId:"town",name:"公交车站",aliases:["公交車站","巴士站","Bus Stop"],icon:"Map",peopleIds:[],hours:"巴士修复後 10:00–17:00 可搭車前往卡利科沙漠",requires:"完成金库收集包或 Joja 巴士项目后修复巴士",services:["连接农场与鹈鹕镇","搭乘巴士前往卡利科沙漠","矿车修复后可由此快速移动"]},
    ...
    {id:"mines",regionId:"mountain",name:"矿井",aliases:["礦井","The Mines"],icon:"MinesEntrance",peopleIds:["dwarf"],hours:"開放後可隨時進入",requires:"第一年春季初期劇情後開放",services:["採礦與戰鬥","固定寶箱層","矿井內矮人商店","20／60／100 层可钓鱼"],fishingAreaId:"mine20"},
